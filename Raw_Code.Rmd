---
title: "Exercises 1"
author: "Wenying Hu, Xueru Rong, Zhaoshun (Jason) Su"
date: "August 9, 2018"
...
&P(D)=0.000025\\
&P(D')=1-P(D)=0.999975\\
&P(D|Pos)=\frac{P(D \ and \ Pos)}{P(Pos)}=\frac{P(D \ and \ Pos)}{P(D \ and \ Pos)+P(D' \ and \ Pos)}=\frac{P(Pos|D) \times P(D)}{P(Pos|D) \times P(D)+P(Pos|D') \times P(D')}\\
